...
def detectText(image):
    ...
    dilated = cv2.dilate(thresh,kernel,iterations = 3) # dilate (the number of iterations is experimental, change if needed)
    ...
    ret = np.array(ret)
    return ret # = list of [x, y, w, h] contour rectangles
    '''
